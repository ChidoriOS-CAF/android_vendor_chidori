...
# Set all versions
CHIDORI_VERSION := ChidoriOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(CHIDORI_BUILD)-$(CHIDORI_BUILD_TYPE)$(CHIDORI_POSTFIX)
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.chidori.buildtype=$(CHIDORI_BUILD_TYPE)
