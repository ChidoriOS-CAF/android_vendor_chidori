...
ifeq ($(call is-board-platform-in-list, $(UM_4_9_FAMILY)),true)
    ...
    QCOM_HARDWARE_VARIANT := $(shell echo $(TARGET_BOARD_PLATFORM) | sed -e 's/msm//')
endif
endif
endif
endif
